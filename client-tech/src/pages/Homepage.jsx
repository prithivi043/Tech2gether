...
export default function HomePage() {
  return (
    <div className="min-h-screen font-sans text-gray-100 bg-gradient-to-b from-sky-500 via-blue-700 to-blue-900 relative overflow-hidden">
      ...
      {/* === Cursor Particles === */}
      <MouseParticles
        g={1} // gravity effect (subtle)
        num={4} // number of particles
        color="skyblue" // professional color
        cull="section, a, button" // don't show inside these elements
        level={6} // intensity
      />
      ...
      >
        ...
        <div className="absolute top-20 left-10 w-80 h-80 bg-sky-400 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-900 rounded-full blur-3xl opacity-30 animate-pulse"></div>

        <motion.h1
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          className="text-5xl md:text-7xl font-extrabold leading-tight drop-shadow-2xl bg-gradient-to-r from-white via-blue-200 to-sky-400 bg-clip-text text-transparent"
        >
        ...
        >
          We transform your ideas into modern websites, striking designs,
          and user-first digital products.
        </motion.p>
      ...
      <section
        id="services"
        className="py-28 px-6 bg-gradient-to-b from-blue-800 to-blue-950"
      >
      ...
      <section
        id="blog"
        className="py-28 px-6 bg-gradient-to-b from-blue-950 to-black"
      >
        <div className="max-w-6xl mx-auto text-center">
          <motion.h2
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <p className="text-blue-300 mb-14 max-w-2xl mx-auto">
            Insights, trends, and updates from the world of design and
            development.
          </p>
